...
class ShowTimeExtractor:
	...
	def json_to_html(self, theaters):
				...
				<div class="theater-id col-md-5">
					...
					<div class="theater-Info">
						<div class="row">
							...
							<div class="col-md-10">""" + each['theater_data']['address']  + """</div>
						</div>
					</div>
					<div class="theater-Info">
						<div class="row">
							<div class="col-md-1"><i class="fa fa-phone"></i></div>
							<div class="col-md-10">""" + each['theater_data']['phone'].replace("Phone:","").replace(",", "<br>") + """</div>
						</div>
					</div>
				</div>
		...
		<hr">"""
			...
			# term = "addMarker('" + ll.split(",")[0]  +"', '" + ll.split(",")[1] + "' , ' " + each['name'] +" ');"
			# print term
...
a = ShowTimeExtractor('Delhi', 'http://www.moviebuff.com/baahubali-the-beginning-2015-hindi')
t = a.get_times()
a.json_to_html(t)